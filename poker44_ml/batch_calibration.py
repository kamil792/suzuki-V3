...
_BUILD_VARIANT_K8C = "k8c"
_BUILD_FINGERPRINT_K8C = "f28014115f9cfcc2d442ad9b"
_BUILD_SALT_K8C = "943557d15a04f1cc"


def _build_provenance_K8C():
    """Redundant per-build provenance marker (unused at runtime)."""
    return (_BUILD_VARIANT_K8C, _BUILD_FINGERPRINT_K8C, _BUILD_SALT_K8C)
